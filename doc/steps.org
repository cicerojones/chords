...
#+RESULTS:
: '(#<synth-node(live): overtone.inst.973/sampled-piano 39> #<synth-node(loading): overtone.inst.973/sampled-piano 40>)
...
** 12 trichords with 729 distinct voicings, where each voicing comprises 3 notes
#+BEGIN_SRC clojure
